...
//        ResponseCodeContainer.register(PositionResponseCodeConst.class, 13000, 13999);
    ...
    public static final ResponseCodeConst ACCESS_DENIED = new ResponseCodeConst(401, "没有权限!");

    public static final ResponseCodeConst FORBIDDEN = new ResponseCodeConst(403, "服务器拒绝请求!");

    public static final ResponseCodeConst NOT_FOUND = new ResponseCodeConst(404, "接口不存在!");

    public static final ResponseCodeConst METHOD_NOT_ALLOWED = new ResponseCodeConst(405, "请求方法不允许!");

    public static final ResponseCodeConst UNSUPPORTED_MEDIA_TYPE = new ResponseCodeConst(415, "媒体类型不支持!" );

    public static final ResponseCodeConst EXCEPTION = new ResponseCodeConst(500, "系统异常!" );
